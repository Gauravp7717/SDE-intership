    ...
    <div className="p-4">
      ...
      <div className="mt-8 flex justify-center gap-4">
        <button
          ...
          className="px-8 py-2.5 bg-green-500 text-white font-medium rounded-md"
        >
          Update
        </button>
        <button
          onClick={handleClose}
          className="px-8 py-2.5 bg-orange-500 text-white font-medium rounded-md"
        >
          Close
        </button>
      </div>
...
function SystemSection() {
  ...
  const handleUpdate = () => console.log(formData);
...
function SalesSection() {
  ...
  const handleUpdate = () => console.log("Sales updated");
  const handleClose = () => console.log("Closed");
...
function PrefixesSection() {
  const handleUpdate = () => console.log("Updated Prefixes");
  const handleClose = () => console.log("Closed");
  ...
  <FormField label={label}>
    <label className="flex items-center space-x-2">
      <input
        ...
        checked={checked}
        onChange={(e) =>
          onChange.length === 1 ? onChange(e) : onChange(e.target.checked)
        }
        className="w-4 h-4"
      />
...
const FileUpload = ({ label, onChange }) => (
  <FormField label={label}>
    <input
      ...
      accept="image/*"
      onChange={onChange}
      className="block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-sky-100 file:text-sky-600 cursor-pointer"
    />
  </FormField>
);
