...
export default function PurchaseReturnForm() {
  ...
  const couponDiscountAmount =
    salesData.couponType === "Percent"
      ? (subtotal * couponValue) / 100
      : couponValue;

  // discount on all amount depending on type
  const discountOnAllAmount =
    salesData.discountOnAllType === "Percent"
      ? (subtotal * discountOnAll) / 100
      : discountOnAll;

  const grandTotal =
    subtotal + otherCharges - couponDiscountAmount - discountOnAllAmount;
    ...
    <div className="bg-gray-50 min-h-screen py-8 px-4 md:px-8">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-lg font-medium text-gray-700 border-b pb-2 mb-3">
              Additional Details
            </h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600 mb-2">
              Advance: ₹ {Number(salesData.advanceAmount).toFixed(3)}
            </div>
            ...
            <div className="flex items-center gap-3 mb-3">
              <input
                ...
                id="adjustAdvance"
              />
              <label htmlFor="adjustAdvance" className="text-sm text-gray-700">
