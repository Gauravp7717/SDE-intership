...
export default function ImportCustomer() {
  const instructions = [
    { id: 1, column: "Customer Name", value: "Required", details: "" },
  ...
  return (
    <ImportSection
      ...
      uploadLabel="Import Customers*"
      icon={<Users size={28} />}
      instructions={instructions}
      downloadExampleLink="/samples/customer_import.csv"
      onImport={() => alert("Importing customers...")}
