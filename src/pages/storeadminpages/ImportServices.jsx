...
export default function ImportServices() {
  const instructions = [
    { id: 1, column: "Service Name", value: "Required", details: "" },
  ...
  return (
    <ImportSection
      ...
      uploadLabel="Import Services*"
      icon={<Users size={28} />}
      instructions={instructions}
      downloadExampleLink="/samples/service_import.csv"
      onImport={() => alert("Importing Services...")}
