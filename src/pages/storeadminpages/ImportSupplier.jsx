...
export default function ImportCustomer() {
  const instructions = [
    { id: 1, column: "Suppiler Name", value: "Required", details: "" },
  ...
  return (
    <ImportSection
      ...
      uploadLabel="Import Suppliers*"
      icon={<Users size={28} />}
      instructions={instructions}
      downloadExampleLink="/samples/suppilers_import.csv"
      onImport={() => alert("Importing suppilers...")}
