  ...
  return (
    <div className="p-6 min-h-screen relative ">
      ...
      >
        ...
        <div className="mb-2">
          <h2 className="text-2xl font-bold text-gray-800">Tenant list</h2>
        </div>
          ...
          <table className="min-w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-left font-bold  text-gray-700 tracking-wider text-xs w-1/12">
                  Sr.
                </th>
                <th className="px-6 py-3 text-left font-bold text-gray-700  tracking-wider text-xs w-2/12">
                  Name
                </th>
                <th className="px-6 py-3 text-left font-bold text-gray-700  tracking-tight text-xs w-2/12">
                  Organisation id
                </th>
                <th className="px-6 py-3 text-left font-bold text-gray-700  tracking-wider text-xs w-2/12">
                  Plan name
                ...
                <th className="px-6 py-3 text-center font-bold text-gray-700  tracking-wider text-xs w-1/12">
                  Status
                </th>
                <th className="px-6 py-3 text-center font-bold text-gray-700  tracking-wider text-xs w-2/12">
                  Action
                </th>
              </tr>
            </thead>
